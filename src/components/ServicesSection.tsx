...
const services = [
  ...
  { icon: Brain, title: "Terapia para Adolescentes", desc: "Acompanhamento especializado para adolescentes em sua jornada de autoconhecimento." },
  { icon: Sparkles, title: "Transtornos de Humor", desc: "Tratamento para transtornos de humor em adolescentes e adultos com abordagem integrativa." },
